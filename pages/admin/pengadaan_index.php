...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="active"><a href="#"><i class="fa fa-file-text"></i> Pengadaan</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
                ...
                <a href="pengadaan_create.php" class="pull-right"><button class="btn btn-block btn-social btn-primary"><i class="fa fa-pencil"></i>Input SPK</button></a>
            </div>
            <div class="box-body">
                  ...
                  <tbody>
                    ...
                    $no = 1;
                      if ($_SERVER['REQUEST_METHOD'] == "POST") {
                        ...
                        if ($pencarian != '') {
                          ...
                          $query = "SELECT * FROM pengada LIMIT $posisi, $batas";
                          $queryJml = "SELECT * FROM pengada";
                          $no = $posisi + 1;
                        }
                      } else {
                        $query = "SELECT * FROM pengada LIMIT $posisi, $batas";
                      ...
                      while ($data = mysqli_fetch_array($sql_tabel)) { ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="pengadaan_update.php?id=<?php echo $data['id'] ?>"><button type="button" class="btn btn-default btn-xs" data-widget="Edit" data-toggle="tooltip" title="Edit"><span class="fa fa-edit"></span></button></a>
                            <a href="pengadaan_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Apakah Anda Yakin?');"><button type="button" class="btn btn-danger btn-xs" data-widget="Hapus" data-toggle="tooltip" title="Hapus"><span class="fa fa-trash"></span></button></a>
                          </td>
                        </tr>
                      <?php
                      }
                    ...
                    <div style="float: right;">
                      <ul class="pagination pagination-sm">
                          ...
                          ?>
                              <li><a href="pengadaan_index.php?hal=1">First</a></li>
                              <li><a href="pengadaan_index.php?hal=<?php echo $link_prev; ?>">&laquo;</a></li>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          ?>
                              <li <?php echo $link_active; ?>><a href="pengadaan_index.php?hal=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          ?>
                              <li><a href="pengadaan_index.php?hal=<?php echo $link_next; ?>">&raquo;</a></li>
                              <li><a href="pengadaan_index.php?hal=<?php echo $jumlah_page; ?>">Last</a></li>
                          <?php
                          }
                          ?>
                      </ul>
