...
if(isset($_POST['bts'])):
     ...
     if($stmt->execute()):
          echo "<script>alert('Berhasil Menambahkan Amandemen Baru');location.href='pengawas.php'</script>";
     else:
                ...
                <form method="post" class="form-auth-small">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="col-md-6 pull-right">
                      <a href="pengawas.php"><button type="button" class="btn btn-danger btn-md btn-block" onclick="return confirm('Apakah Anda Yakin?');">Cancel</button></a>
                  </div>
                </form>
              </div>
          </div>
