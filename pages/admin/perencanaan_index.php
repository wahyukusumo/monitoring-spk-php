...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="active"><a href="#"><i class="fa fa-list-alt"></i> Perencanaan</a></li>
      </ol>
    </section>
                  ...
                  <tbody>
                      ...
                      if ($_SERVER['REQUEST_METHOD'] == "POST") {
                        ...
                        if ($pencarian != '') {
                          $sql = "SELECT * FROM pengada
                                  WHERE status='0' AND no_spk LIKE '%$pencarian%'
                          ...
                          $query = "SELECT * FROM pengada WHERE status='0' LIMIT $posisi, $batas";
                          $queryJml = "SELECT * FROM pengada WHERE status='0'";
                          $no = $posisi + 1;
                        }
                      } else {
                        $query = "SELECT * FROM pengada WHERE status='0' LIMIT $posisi, $batas";
                      ...
                      while ($data = mysqli_fetch_array($sql_tabel)) { ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="perencanaan_update.php?id=<?php echo $data['id'] ?>"><button type="button" class="btn btn-primary btn-xs">APPROVE</button></a>
                          </td>
                        </tr>
                      <?php
                      }
                    ...
                    <div style="float: right;">
                      <ul class="pagination pagination-sm">
                          ...
                          ?>
                              <li><a href="perencanaan_index.php?page=1">First</a></li>
                              <li><a href="perencanaan_index.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          ?>
                              <li <?php echo $link_active; ?>><a href="perencanaan_index.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          ?>
                              <li><a href="perencanaan_index.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                              <li><a href="perencanaan_index.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                          <?php
                          }
                          ?>
                      </ul>
