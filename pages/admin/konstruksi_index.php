        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
                ...
                <a href="konstruksi_list.php" class="pull-right"><button class="btn btn-block btn-social btn-default"><i class="ion ion-clipboard"></i>Daftar Amandemen</button></a>
            </div>
            <div class="box-body">
                  ...
                  <tbody>
                    ...
                    <div style="float: right;">
                      <ul class="pagination pagination-sm">
                          ...
                          ?>
                              <li><a href="konstruksi_index.php?page=1">First</a></li>
                              <li><a href="konstruksi_index.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          ?>
                              <li <?php echo $link_active; ?>><a href="konstruksi_index.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          ?>
                              <li><a href="konstruksi_index.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                              <li><a href="konstruksi_index.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                          <?php
                          }
                          ?>
                      </ul>
