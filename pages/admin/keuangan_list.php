        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
                ...
                <a href="keuangan_index.php" class="pull-right"><button class="btn btn-block btn-social btn-default"><i class="ion ion-clipboard"></i>Daftar SPK</button></a>
            </div>
            <div class="box-body">
                  ...
                  <tbody>
                      ...
                      while ($data = mysqli_fetch_array($sql_tabel)) { ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="keuangan_update.php?id=<?php echo $data['id'] ?>"><button type="button" class="btn btn-default btn-xs"  data-widget="Edit" data-toggle="tooltip" title="Edit"><span class="fa fa-edit"></span></button></a>
                            <a href="keuangan_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Apakah Anda Yakin?');"><button type="button" class="btn btn-danger btn-xs" data-widget="Hapus" data-toggle="tooltip" title="Hapus"><span class="fa fa-trash"></span></button></a>
                          </td>
                        </tr>
                      <?php
                      }
                    ...
                    <div style="float: right;">
                      <ul class="pagination pagination-sm">
                          ...
                          ?>
                              <li><a href="keuangan_list.php?hal=1">First</a></li>
                              <li><a href="keuangan_list.php?hal=<?php echo $link_prev; ?>">&laquo;</a></li>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          ?>
                              <li <?php echo $link_active; ?>><a href="keuangan_list.php?hal=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          ?>
                              <li><a href="keuangan_list.php?hal=<?php echo $link_next; ?>">&raquo;</a></li>
                              <li><a href="keuangan_list.php?hal=<?php echo $jumlah_page; ?>">Last</a></li>
                          <?php
                          }
                          ?>
                      </ul>
