              ...
              <div class="box-tools pull-right">
                <div class="has-feedback">
                  <form method="post" action="">
                    <input type="text" name="pencarian" class="form-control input-sm" placeholder="Search Mail">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <div class="table-responsive mailbox-messages">
                      ...
                      include('../../config.php');
                        ...
                        $hal = @$_GET['hal'];
                          ...
                          if ($_SERVER['REQUEST_METHOD'] == "POST") {
                            ...
                            if ($pencarian != '') {
                              $sql = "SELECT * FROM mail WHERE to LIKE '%$pencarian%' OR subject LIKE '%$pencarian%' LIMIT $posisi, $batas";
                              $query = $sql;
                              $queryJml = $sql;
                            } else {
                  ...
                  <tr>
                    <td class="mailbox-name"><a href="read-mail.html"><?php echo $data['to']?></a></td>
                    <td class="mailbox-subject"><b><?php echo $data['subject']?></b> - <?php echo $data['isi']?>
                    </td>
