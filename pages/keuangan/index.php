        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
                ...
                <a href="list.php" class="pull-right"><button class="btn btn-block btn-social btn-default"><i class="ion ion-clipboard"></i>Daftar Pembayaran</button></a>
            </div>
            <div class="box-body">
                      ...
                      while ($data = mysqli_fetch_array($sql_tabel)) { ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="create.php?id=<?php echo $data['id'] ?>">
                          <?php
