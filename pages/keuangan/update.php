                ...
                <form method="post" class="form-auth-small">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 pull-right">
                      <a href="keuangan_index.php"><button type="button" class="btn btn-danger btn-sm btn-block" onclick="return confirm('Apakah Anda Yakin?');"><i class="fa fa-close"></i></button></a>
                  </div>
                </form>
              </div>
              <?php
