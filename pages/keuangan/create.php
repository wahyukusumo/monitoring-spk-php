            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <form method="post" class="form-auth-small">
                  ...
                  <div class="form-group">
                    <h5>Nilai</h5>
                    <input type="text" class="form-control" required="" name="nilai_bayar" placeholder="Nilai">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 pull-right">
                      <a href="index.php"><button type="button" class="btn btn-danger btn-md btn-block" onclick="return confirm('Apakah Anda Yakin Ingin Membatalkan?');">Batal</i></button></a>
                  </div>
                </form>
              </div>
              <?php
