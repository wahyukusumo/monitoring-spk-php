    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php
          ...
          echo "<li><a href=\"#\"><i class=\"fa fa-circle-o text-light-blue\"></i>Daftar SPK</a></li>";  
          echo "<li><a href=\"#\"><i class=\"fa fa-circle-o text-light-blue\"></i>Input SPK</a></li>";  
          echo "</ul>";
          echo "</li>";
        ?>
        <?php
        ...
        if ($_SESSION['level'] == "Konstruksi") {
          ...
          echo "</span></a>";      
          echo "<ul class=\"treeview-menu\">";
          echo "<li class=\"active\"><a href=\"index.php\"><i class=\"fa fa-wrench text-light-blue\"></i>Konstruksi</a></li>";
          ...
          echo "</ul></li> ";
        } elseif ($_SESSION['level'] == "Transaksi Energi") {
          echo "<li class=\"treeview active\">";
          echo "<a href=\"#\">";
          echo "<i class=\"fa fa-camera\"></i> <span>Pengawas</span>";  
          echo "<span class=\"pull-right-container\">";  
          ...
          echo "<li class=\"active\"><a href=\"index.php\"><i class=\"fa fa-expand text-light-blue\"></i>Transaksi Energi</a></li>";
          echo "<li><a href=\"#\"><i class=\"fa fa-bolt text-light-blue\"></i>Jaringan</a></li>";  
          echo "</ul></li> ";
        } elseif ($_SESSION['level'] == "Jaringan") {
          echo "<li class=\"treeview active\">";
          echo "<a href=\"#\">";
          echo "<i class=\"fa fa-camera\"></i> <span>Pengawas</span>";  
          echo "<span class=\"pull-right-container\">";  
          ...
          echo "<li><a href=\"#\"><i class=\"fa fa-wrench text-light-blue\"></i>Konstruksi</a></li>";
          echo "<li><a href=\"#\"><i class=\"fa fa-expand text-light-blue\"></i>Transaksi Energi</a></li>";  
          echo "<li class=\"active\"><a href=\"index.php\"><i class=\"fa fa-bolt text-light-blue\"></i>Jaringan</a></li>";  
          echo "</ul></li> ";
        } else {
          echo "<li class=\"treeview\">";
          echo "<a href=\"#\">";
