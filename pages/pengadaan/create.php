...
if(isset($_POST['bts'])):
     ...
     if($stmt->execute()):
          echo "<script>alert('Berhasil Menambahkan Kontrak Baru');location.href='index.php'</script>";
     else:
          ...
          <div class="box box-primary">
            <div class="box-body">
                <form class="form-auth-small" method="post">
                  ...
                  <div class="form-group">
                    <h5>Akhir SPK</h5>
                    <input type="date" class="form-control" required="" placeholder="Akhir" name="akhir_spk"/>
                  </div>
                  <div class="form-group">
                    <h5>Uraian SPK</h5>
