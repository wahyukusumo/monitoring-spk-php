        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
                ...
                <a href="create.php" class="pull-right"><button class="btn btn-block btn-social btn-primary"><i class="fa fa-pencil"></i>Input SPK</button></a>
            </div>
            <div class="box-body">
                  ...
                  <tbody>
                    ...
                    <div style="float: right;">
                      <ul class="pagination pagination-sm">
                          ...
                          ?>
                              <li><a href="index.php?hal=1">First</a></li>
                              <li><a href="index.php?hal=<?php echo $link_prev; ?>">&laquo;</a></li>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          ?>
                              <li <?php echo $link_active; ?>><a href="index.php?hal=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                          <?php
                          }
                          ?>
                          <?php
                          ...
                          ?>
                              <li><a href="index.php?hal=<?php echo $link_next; ?>">&raquo;</a></li>
                              <li><a href="index.php?hal=<?php echo $jumlah_page; ?>">Last</a></li>
                          <?php
                          }
                          ?>
                      </ul>
