  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="export_pembayaran.php"><i class="fa fa-link"></i> <span>Monitoring Pembayaran</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
                ...
                <tbody>
                  <?php include 'config.php';
                      if ($_SERVER['REQUEST_METHOD'] == "POST") {
                        $pencarian = trim(mysqli_real_escape_string($conn, $_POST['pencarian']));
                          if ($pencarian != '') {
                            $sql = "SELECT * FROM keuangan WHERE no_spk LIKE '%$pencarian%'";
                            $query = $sql;
                          } else {
                  ...
                  ?>
    				...
    				<div class="box-footer with-border">
    					...
    					<form action="action_pembayaran.php" method="post" class="pull-right">
